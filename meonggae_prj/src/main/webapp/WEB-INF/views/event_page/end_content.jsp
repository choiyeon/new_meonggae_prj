    ...
    <div class="list list--event">
        <ul class="list-ul">
            <c:forEach var="evtDomain" items="${eventList}" varStatus="i">
                ...
                <!-- 날짜 비교 조건: 종료 날짜가 현재 날짜보다 작은 경우 -->
                <c:if test="${eventEndYear lt currentYear or (eventEndYear eq currentYear and eventEndMonth lt currentMonth) or (eventEndYear eq currentYear and eventEndMonth eq currentMonth and eventEndDay lt currentDay)}">
                    <li class="list-item">
